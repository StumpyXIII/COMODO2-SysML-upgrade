...
namespace Components {
  ...
  void SlewUseCaseBlockComponentImpl::execute_SlewForOpticalCommPayload(const PropulsionSubsystem& PropulsionSubystemObject)
  {
  ...
  void SlewUseCaseBlockComponentImpl::execute_getDesignT2D(const PropulsionSubsystem& inputObject)
  {
