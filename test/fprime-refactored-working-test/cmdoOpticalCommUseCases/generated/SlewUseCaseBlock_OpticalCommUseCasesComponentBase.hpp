#ifndef SLEWUSECASEBLOCK_OPTICALCOMMUSECASES_COMPONENT_BASE_HPP
#define SLEWUSECASEBLOCK_OPTICALCOMMUSECASES_COMPONENT_BASE_HPP
...
namespace Components {
  ...
  class SlewUseCaseBlock_OpticalCommUseCasesComponentBase : public Fw::ActiveComponentBase {
  public:
    SlewUseCaseBlock_OpticalCommUseCasesComponentBase(const char* const compName);
    virtual ~SlewUseCaseBlock_OpticalCommUseCasesComponentBase();
...
#endif // SLEWUSECASEBLOCK_OPTICALCOMMUSECASES_COMPONENT_BASE_HPP
